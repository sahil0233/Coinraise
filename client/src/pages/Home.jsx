      ...
      <div className='w-full relative'>
        ...
        <section class="w-[250px] top-44 md:w-[600px] absolute left-1/2 transform -translate-x-1/2 left- bg-white rounded-lg shadow-lg px-4 py-4 sm:py-8 grid grid-cols-1 md:grid-cols-3 gap-4 sm:top-80">
          <div class="text-center">
            <h2 class="sm:text-2xl font-bold text-gray-800 sm:mb-2">1930 ETH + Raised</h2>
          </div>
          <div class="text-center">
            <h2 class="sm:text-2xl font-bold text-gray-800 sm:mb-2">100,000 + Fundraisers</h2>
          </div>
          <div class="text-center">
            <h2 class="sm:text-2xl font-bold text-gray-800 sm:mb-2">1.5 lakhs + Donations</h2>
          </div>
        </section>
        ...
        <div className='mt-20 flex flex-col items-center gap-2'>
          ...
          <div className='flex mt-10 py-2 justify-evenly flex-wrap'>
            <a  className='flex flex-col items-center w-[30%] sm:w-[10%]'>
  ...
  <section class="mb-32 text-gray-800 text-center">
    ...
    <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      <div class="mb-12 md:mb-0">
        ...
        <h5 class="text-lg font-bold mb-4">Anjali Hasani</h5>
        <p class="mb-4">
          ...
          Thank you very much because of this site i was able to raise money for my brain surgery and now i feel better
        </p>
      ...
      <div class="mb-12 md:mb-0">
        ...
        <h5 class="text-lg font-bold mb-4">Disha Nagori</h5>
        <p class="mb-4">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left"
            class="w-6 pr-2 inline-block" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="currentColor"
          ...
          </svg>It a wonderful site I raised 100 eth successfully for my beauty makeup startup
        </p>
        <ul class="flex justify-center mb-0">
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-yellow-500"
      ...
      <div class="mb-0">
        ...
        <h5 class="text-lg font-bold mb-4">Parv Rathore</h5>
        <p class="mb-4">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left"
            class="w-6 pr-2 inline-block" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="currentColor"
          ...
          </svg>making donations here is 100% legitimate.Would definately recommend everyone
        </p>
        <ul class="flex justify-center mb-0">
          <li>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-yellow-500"
